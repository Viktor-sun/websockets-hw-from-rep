...
// =================================================
socket.on("user/count", appendUserCount);

function appendUserCount(count) {
  // console.log(count);
  const markup = `<p>Всего пользователей в чате ${count}</p>`;
  refs.section.innerHTML = "";
  refs.section.insertAdjacentHTML("afterbegin", markup);
}
// ===================================================
